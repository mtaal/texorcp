...
public class MusicPackageImpl extends EPackageImpl implements MusicPackage {
	 ...
	 * @generated
	 */
	private EClass rcpHelperEClass = null;
	 ...
	 * 
	 * <p>
	 * This method is used to initialize {@link MusicPackage#eINSTANCE} when
	...
	public static MusicPackage init() {
		if (isInited)
			return (MusicPackage) EPackage.Registry.INSTANCE
					.getEPackage(MusicPackage.eNS_URI);

		// Obtain or create and register package
		MusicPackageImpl theMusicPackage = (MusicPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof MusicPackageImpl ? EPackage.Registry.INSTANCE
				.get(eNS_URI) : new MusicPackageImpl());
	 ...
	 * @generated
	 */
	public EClass getRCPHelper() {
		return rcpHelperEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getRCPHelper_Albums() {
		return (EReference) rcpHelperEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getRCPHelper_Selected() {
		return (EReference) rcpHelperEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		rcpHelperEClass = createEClass(RCP_HELPER);
		createEReference(rcpHelperEClass, RCP_HELPER__ALBUMS);
		createEReference(rcpHelperEClass, RCP_HELPER__SELECTED);
	...
	public void initializePackageContents() {
		...
		initEClass(artistEClass, Artist.class, "Artist", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getArtist_Id(), ecorePackage.getELong(), "id", null, 0,
				1, Artist.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getArtist_Version(), ecorePackage.getELongObject(),
				"version", null, 0, 1, Artist.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getArtist_FirstName(), ecorePackage.getEString(),
				"firstName", null, 0, 1, Artist.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getArtist_LastName(), ecorePackage.getEString(),
				"lastName", null, 0, 1, Artist.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getArtist_BirthDate(), ecorePackage.getEDate(),
				"birthDate", null, 0, 1, Artist.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getArtist_Country(), this.getCountry(), null, "country",
				null, 0, 1, Artist.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getArtist_Genre(), this.getGenre(), null, "genre", null,
				0, 1, Artist.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(albumEClass, Album.class, "Album", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getAlbum_Id(), ecorePackage.getELong(), "id", null, 0,
				1, Album.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAlbum_Version(), ecorePackage.getELongObject(),
				"version", null, 0, 1, Album.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getAlbum_Name(), ecorePackage.getEString(), "name",
				null, 0, 1, Album.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getAlbum_Artist(), this.getArtist(), null, "artist",
				null, 0, 1, Album.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAlbum_ReleaseDate(), ecorePackage.getEDate(),
				"releaseDate", null, 0, 1, Album.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getAlbum_Genres(), this.getGenre(), null, "genres",
				null, 0, -1, Album.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAlbum_Songs(), this.getSong(), null, "songs", null,
				0, -1, Album.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getAlbum_Ratings(), this.getRating(), "ratings", null,
				0, -1, Album.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(countryEClass, Country.class, "Country", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCountry_Code(), ecorePackage.getEString(), "code",
				null, 1, 1, Country.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getCountry_Version(), ecorePackage.getELongObject(),
				"version", null, 0, 1, Country.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		...
		initEClass(genreEClass, Genre.class, "Genre", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getGenre_Id(), ecorePackage.getELong(), "id", null, 0,
				1, Genre.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getGenre_Version(), ecorePackage.getELongObject(),
				"version", null, 0, 1, Genre.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getGenre_Name(), ecorePackage.getEString(), "name",
				null, 1, 1, Genre.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEClass(songEClass, Song.class, "Song", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSong_Id(), ecorePackage.getELong(), "id", null, 0, 1,
				Song.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSong_Version(), ecorePackage.getELongObject(),
				"version", null, 0, 1, Song.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getSong_Track(), ecorePackage.getEInt(), "track", null,
		...
		initEClass(rcpHelperEClass, RCPHelper.class, "RCPHelper", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRCPHelper_Albums(), this.getAlbum(), null, "albums",
				null, 0, -1, RCPHelper.class, IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRCPHelper_Selected(), this.getAlbum(), null,
				"selected", null, 0, 1, RCPHelper.class, IS_TRANSIENT,
	...
	protected void createDisplayLabelAnnotations() {
		...
		addAnnotation(artistEClass, source, new String[] { "value",
				"${firstName} ${lastName}" });
		addAnnotation(albumEClass, source, new String[] { "value", "${name}" });
		addAnnotation(countryEClass, source,
				new String[] { "value", "${name}" });
		addAnnotation(genreEClass, source, new String[] { "value", "${name}" });
	}
	...
	protected void createNaturalOrderingAnnotations() {
		...
		addAnnotation(artistEClass, source, new String[] { "value",
				"lastName,firstName" });
		addAnnotation(albumEClass, source, new String[] { "value", "name" });
		addAnnotation(countryEClass, source, new String[] { "value", "name" });
		addAnnotation(genreEClass, source, new String[] { "value", "name" });
	}
	...
	protected void createTeneoAnnotations() {
		...
		addAnnotation(getArtist_Id(), source, new String[] { "value",
				"@Id @GeneratedValue" });
		addAnnotation(getArtist_Version(), source, new String[] { "value",
				"@Version" });
		addAnnotation(getAlbum_Id(), source, new String[] { "value",
				"@Id @GeneratedValue" });
		addAnnotation(getAlbum_Version(), source, new String[] { "value",
				"@Version" });
		addAnnotation(getAlbum_Genres(), source, new String[] { "value",
				"@ManyToMany" });
		addAnnotation(getAlbum_Songs(), source, new String[] { "value",
				"@OneToMany" });
		addAnnotation(getCountry_Code(), source,
				new String[] { "value", "@Id" });
		addAnnotation(getCountry_Version(), source, new String[] { "value",
				"@Version" });
		addAnnotation(getGenre_Id(), source, new String[] { "value",
				"@Id @GeneratedValue" });
		addAnnotation(getGenre_Version(), source, new String[] { "value",
				"@Version" });
		addAnnotation(getSong_Id(), source, new String[] { "value",
				"@Id @GeneratedValue" });
		addAnnotation(getSong_Version(), source, new String[] { "value",
				"@Version" });
	}
	...
	protected void createSearchableAnnotations() {
		...
		addAnnotation(getArtist_LastName(), source, new String[] { "value",
				"true" });
		addAnnotation(getCountry_Code(), source, new String[] { "value", "no" });
	}
	...
	protected void createMaxLengthAnnotations() {
		...
		addAnnotation(getCountry_Code(), source, new String[] { "value", "2" });
		addAnnotation(getSong_Track(), source, new String[] { "value", "2" });
		addAnnotation(getSong_Name(), source, new String[] { "value", "40" });
	}
	...
	protected void createDisplayLengthAnnotations() {
		...
		addAnnotation(getCountry_Name(), source, new String[] { "value", "40" });
	}
